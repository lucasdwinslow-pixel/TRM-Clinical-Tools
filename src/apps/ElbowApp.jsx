...
export default function ElbowApp() {
  return (
    <div style={{ background: BLACK, minHeight: "100dvh",
      fontFamily: "'Inter',system-ui,sans-serif", color: WHITE }}>

      {/* Sticky header — matches ShoulderApp/ElbowApp pattern exactly */}
      <div style={{ background: DARK, borderBottom: `1px solid ${BORDER}`,
      ...
      <div style={{ maxWidth: 900, margin: "0 auto",
        ...
        <div style={{ background: CARD, borderRadius: 16,
          border: `1px solid ${BORDER}`, padding: "60px 40px",
      ...
      <div style={{ borderTop: `1px solid ${BORDER}`,
        ...
        <span style={{ fontFamily: "'Arial Black',sans-serif",
          fontWeight: 900, color: WHITE, fontSize: 13 }}>TRM</span>
