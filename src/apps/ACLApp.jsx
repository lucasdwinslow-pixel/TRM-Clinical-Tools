...
// ─── CONSTANTS ────────────────────────────────────────────────────────────────
const LIME     = "#b8ff57";   // canonical TRM lime — matches all other apps
const LIME_DIM = "#8fd64a";   // gradient end / dim accent
const BLACK    = "#0a0a0a";   // true background
const DARK     = "#111111";   // page bg
const CARD     = "#181818";   // card / panel bg
const BORDER   = "#2a2a2a";   // subtle dividers
const MUTED    = "#888888";   // secondary / label text
const WHITE    = "#ffffff";
const GOLD     = "#fbbf24";
