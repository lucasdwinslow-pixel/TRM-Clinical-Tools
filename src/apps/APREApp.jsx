...
function BackButton() {
  return (
    ...
    >
      ...
      <img src={TRM_LOGO} alt="TRM" style={{ height: 22, width: "auto", display: "block" }} />
    </a>
  );
}
